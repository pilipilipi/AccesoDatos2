...
import es.pilar.dam.AccesoDatos2.ejercicio16.pool.MyDataSource;
...
public class ModeloDAOImpl implements ModeloDAO {
	...
	@Override
	public List<Alumno> todosLosAlumnos() throws SQLException {
		String sql = "SELECT id, nombre " 
				+ "FROM alumno ";
	...
	@Override
	public Alumno mostrarAlumnoPorId(int id) throws SQLException {
		String sql = "SELECT a.id, a.nia, a.nombre, a.apellidos, a.ciclo, a.curso, a.grupo, a.genero, a.fecha, g.nombre as nombre_grupo " 
				+ "FROM alumno a " 
				+ "INNER JOIN grupo g ON a.grupo = g.id "
				+ "WHERE a.id = ?";
	...
	@Override
	public int cambiarGrupoAlumno(int idAlumno, int idGrupo) throws SQLException {

	    String sql = "UPDATE alumno SET grupo = ? WHERE id = ?";
